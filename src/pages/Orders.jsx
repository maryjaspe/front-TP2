    ...
    <div>
      ...
      <div className="flex w-full gap-[24px] p-8 fle">
        {isLoading ? (
          ...
          <div>Aún no tienes órdenes creadas.</div>
        ) : (
          orders.map((order) => {
            return (
              <div
                key={order.id}
                className="flex flex-col w-[200px] gap-[12px] shadow-md p-4"
              >
                <div
                  className={`px-2 py-1 rounded-full text-center text-white font-semibold text-sm ${
